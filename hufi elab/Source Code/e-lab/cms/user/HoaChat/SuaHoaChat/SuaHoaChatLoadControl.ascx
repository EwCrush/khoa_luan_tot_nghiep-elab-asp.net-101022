<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuaHoaChatLoadControl.ascx.cs" Inherits="e_lab.cms.user.HoaChat.SuaHoaChat.SuaHoaChatLoadControl_" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Cập nhật số lượng tồn của hóa chất <%=getmahc() %> trong <%=getmadv() %></div>
</div>
