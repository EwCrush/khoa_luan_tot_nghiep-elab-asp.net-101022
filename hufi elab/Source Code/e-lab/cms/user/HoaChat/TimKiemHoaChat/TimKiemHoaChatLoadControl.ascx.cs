...
namespace e_lab.cms.user.HoaChat.TimKiemHoaChat
{
    public partial class TimKiemHoaChatLoadControl : System.Web.UI.UserControl
    {
        string trang = "";
        int trangcuoi = 0;
        int trangtruoc = 0;
        ...
        protected int getlast()
        {
            int tonghang = 0;
            DataTable dt = new DataTable();
            dt = e_lab.VatTuKhoa.ds_hoachatkhoa_search(Session["MaDonVi"].ToString(), keyword);
        ...
        {
            DataTable dt = new DataTable();
            dt = e_lab.VatTuKhoa.ds_hoachatkhoa_search_pagination(Session["MaDonVi"].ToString(), keyword, getoffset());
