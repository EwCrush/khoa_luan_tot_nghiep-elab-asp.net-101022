<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietPhieuXuatDungCu.ascx.cs" Inherits="e_lab.cms.user.PhieuXuat.ChiTietPhieuXuatDungCu.ChiTietPhieuXuatDungCu" %>

<div class="to-do-heading">
    <div class="to-do-heading-icon-list">
        <a href="/User.aspx?modul=PhieuXuat&trang=1"" class="Back" >
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/User.aspx?modul=ChiTietPhieuXuatDungCu&mapxk=<%=getmapx() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/User.aspx?modul=ChiTietPhieuXuatDungCu&mapxk=<%=getmapx() %>&trang=<%=getnext() %>" class="ThemMoi">
