<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietPhieuXuatThietBi.ascx.cs" Inherits="e_lab.cms.user.PhieuXuat.ChiTietPhieuXuatThietBi.ChiTietPhieuXuatThietBi" %>
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/User.aspx?modul=ChiTietPhieuXuatThietBi&mapxk=<%=getmapx() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/User.aspx?modul=ChiTietPhieuXuatThietBi&mapxk=<%=getmapx() %>&trang=<%=getnext() %>" class="ThemMoi">
