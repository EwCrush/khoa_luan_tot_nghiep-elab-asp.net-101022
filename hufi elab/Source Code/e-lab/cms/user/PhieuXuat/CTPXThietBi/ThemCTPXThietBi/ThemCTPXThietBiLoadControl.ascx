<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemCTPXThietBiLoadControl.ascx.cs" Inherits="e_lab.cms.user.PhieuXuat.CTPXThietBi.ThemCTPXThietBi.ThemCTPXThietBiLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Thêm thiết bị cho phiếu xuất <%=getmapxk() %></div>
</div>
