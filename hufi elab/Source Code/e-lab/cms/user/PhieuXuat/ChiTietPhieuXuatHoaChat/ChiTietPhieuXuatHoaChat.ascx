<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietPhieuXuatHoaChat.ascx.cs" Inherits="e_lab.cms.user.PhieuXuat.ChiTietPhieuXuatHoaChat.ChiTietPhieuXuatHoaChat" %>
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/User.aspx?modul=ChiTietPhieuXuatHoaChat&mapxk=<%=getmapx() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/User.aspx?modul=ChiTietPhieuXuatHoaChat&mapxk=<%=getmapx() %>&trang=<%=getnext() %>" class="ThemMoi">
