...
namespace e_lab.cms.user.TaiKhoan.TimKiemTaiKhoan
{
    public partial class TimKiemTaiKhoanLoadControl : System.Web.UI.UserControl
    {
        ...
        protected int getlast()
        {
            ...
            dt = e_lab.NhanVien.ds_tk_search_khoa(Session["MaDonVi"].ToString(), keyword);
        ...
        {
            DataTable dt = new DataTable();
            dt = e_lab.NhanVien.ds_tk_search_pagination_khoa(Session["MaDonVi"].ToString(), keyword, getoffset());
