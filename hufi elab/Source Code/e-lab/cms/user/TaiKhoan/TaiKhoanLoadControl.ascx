<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaiKhoanLoadControl.ascx.cs" Inherits="e_lab.cms.user.TaiKhoan.TaiKhoanLoadControl" %>

<div class="to-do-heading">

    <div class="heading-text no-icon-link">Danh sách tài khoản của nhân viên thuộc <%=getmadv() %></div>
    <div class="search">
            <div class="tk">
                <asp:TextBox ID="iptk" CssClass ="cssiptk" runat="server"></asp:TextBox>
                <a href="/User.aspx?modul=TimKiemTaiKhoan&keyword=<%=get_iptk() %>&trang=1" class="ThemMoi">
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/User.aspx?modul=TaiKhoan&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/User.aspx?modul=TaiKhoan&trang=<%=getnext() %>" class="ThemMoi">
