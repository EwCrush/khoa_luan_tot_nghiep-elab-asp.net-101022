<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemCTPNDungCuLoadControl.ascx.cs" Inherits="e_lab.cms.user.PhieuNhap.CTPNDungCu.ThemCTPNDungCu.ThemCTPNDungCuLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Thêm dụng cụ cho phiếu nhập <%=getmapx() %></div>
</div>
