<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuaCTPNThietBiLoadControl.ascx.cs" Inherits="e_lab.cms.user.PhieuNhap.CTPNThietBi.SuaCTPNThietBi.SuaCTPNThietBiLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Cập nhật số lượng cho thiết bị <%=getmatb() %> ở phòng lab <%=getmapl() %> trong phiếu nhập <%=getmapx() %></div>
</div>
