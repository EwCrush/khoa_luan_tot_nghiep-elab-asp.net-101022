<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuaCTPNHoaChatLoadControl.ascx.cs" Inherits="e_lab.cms.user.PhieuNhap.CTPNHoaChat.SuaCTPNHoaChat.SuaCTPNHoaChatLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Cập nhật số lượng cho hóa chất <%=getmahc() %> trong phiếu nhập <%=getmapx() %></div>
</div>
