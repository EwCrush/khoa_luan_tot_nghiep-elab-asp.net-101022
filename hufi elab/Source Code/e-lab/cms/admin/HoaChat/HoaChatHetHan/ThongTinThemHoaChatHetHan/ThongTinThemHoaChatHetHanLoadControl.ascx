<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThongTinThemHoaChatHetHanLoadControl.ascx.cs" Inherits="e_lab.cms.admin.HoaChat.HoaChatHetHan.ThongTinThemHoaChatHetHan.ThongTinThemHoaChatHetHanLoadControl" %>


<div class="to-do-heading">
    <div class="to-do-heading-icon-list">
        <a href="/Admin.aspx?modul=HoaChatHetHan&trang=1" class="Back" <%--style="color:#fff; text-decoration: none"--%>>
