...
namespace e_lab.cms.admin.HoaChat.HoaChatHetHan.ThongTinThemHoaChatHetHan
{
    public partial class ThongTinThemHoaChatHetHanLoadControl : System.Web.UI.UserControl
    {
        string mahc = "";
        string trang = "";
        ...
        private void laythongtinhoachat()
        {
            ...
            dt = e_lab.HoaChat.moreinfo_hc_hethan(mahc);
