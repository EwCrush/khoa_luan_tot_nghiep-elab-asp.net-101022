...
namespace e_lab.cms.admin.NhaSanXuat.TimKiemNhaSanXuat
{
    public partial class TimKiemNhaSanXuatLoadControl : System.Web.UI.UserControl
    {
        string trang = "";
        int trangcuoi = 0;
        int trangtruoc = 0;
        ...
        protected int getlast()
        {
            ...
            dt = e_lab.NhaSanXuat.ds_nsx_search(keyword);
        ...
        {
            DataTable dt = new DataTable();
            dt = e_lab.NhaSanXuat.ds_NhaSanXuat_search_pagination(keyword, getoffset());
