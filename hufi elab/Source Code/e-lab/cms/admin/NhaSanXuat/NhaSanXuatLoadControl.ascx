<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhaSanXuatLoadControl.ascx.cs" Inherits="e_lab.cms.admin.NhaSanXuat.NhaSanXuatLoadControl" %>

<div class="to-do-heading">

    <div class="heading-text no-icon-link">Danh sách nhà sản xuất</div>
    <div class="search">
            <div class="tk">
                <asp:TextBox ID="iptk" CssClass ="cssiptk" runat="server"></asp:TextBox>
                <a href="/Admin.aspx?modul=TimKiemNhaSanXuat&keyword=<%=get_iptk() %>&trang=1" class="ThemMoi">
...
<div class="pagination-wrapper">
    <div class="pagination floatleft-item">
        <a href="/Admin.aspx?modul=ThemNSX" class="ThemMoi">
            <i class="to-do-heading-icon fa-solid fa-circle-plus" title="Thêm"></i>
        </a>
    </div>
    <div class="pagination">
        <a href="/Admin.aspx?modul=NhaSanXuat&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/Admin.aspx?modul=NhaSanXuat&trang=<%=getnext() %>" class="ThemMoi">
