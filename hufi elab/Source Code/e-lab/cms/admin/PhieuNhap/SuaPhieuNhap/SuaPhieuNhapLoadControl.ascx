<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuaPhieuNhapLoadControl.ascx.cs" Inherits="e_lab.cms.admin.PhieuNhap.SuaPhieuNhap.SuaPhieuNhapLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Cập nhật thông tin cho phiếu nhập <%=getmapn() %></div>
</div>
