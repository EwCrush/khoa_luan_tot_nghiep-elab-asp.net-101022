<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuaChiTietPhieuNhapDungCuLoadControl.ascx.cs" Inherits="e_lab.cms.admin.PhieuNhap.ChiTietPhieuNhapDungCu.SuaChiTietPhieuNhapDungCu.SuaChiTietPhieuNhapDungCuLoadControl" %>

<div class="to-do-heading">
    <div class="to-do-heading-icon-list">
        <a href="/Admin.aspx?modul=ChiTietPhieuNhapDungCu&mapn=<%=getmapn() %>&trang=1" class="Back" <%--style="color:#fff; text-decoration: none"--%>>
            <i class="to-do-heading-icon fa-solid fa-circle-chevron-left" title=" Quay lại"></i>
        </a>
    </div>
    <div class="heading-text">Cập nhật số lượng cho dụng cụ <%=getmadc() %> trong phiếu nhập <%=getmapn() %></div>
</div>
