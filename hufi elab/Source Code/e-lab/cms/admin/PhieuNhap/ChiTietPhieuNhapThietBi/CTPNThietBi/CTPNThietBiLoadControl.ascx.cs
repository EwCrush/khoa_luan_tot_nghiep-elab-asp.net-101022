...
namespace e_lab.cms.admin.PhieuNhap.ChiTietPhieuNhapThietBi.CTPNThietBi
{
    public partial class CTPNThietBiLoadControl : System.Web.UI.UserControl
    {
        string trang = "";
        int trangcuoi = 0;
        int trangtruoc = 0;
        ...
        {
            DataTable dt = new DataTable();
            dt = e_lab.PhieuNhap.CTPN_tb_pagination(mapn, getoffset());
            ...
            <td class='tb_mi75 table_info'>" + dt.Rows[i]["TenThietBi"] + @"</td>
