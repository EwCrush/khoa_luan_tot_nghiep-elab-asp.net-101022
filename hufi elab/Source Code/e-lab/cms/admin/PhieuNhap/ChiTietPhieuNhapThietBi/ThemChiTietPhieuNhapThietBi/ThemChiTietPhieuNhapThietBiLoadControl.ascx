<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemChiTietPhieuNhapThietBiLoadControl.ascx.cs" Inherits="e_lab.cms.admin.PhieuNhap.ChiTietPhieuNhapThietBi.ThemChiTietPhieuNhapThietBi.ThemChiTietPhieuNhapThietBiLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Thêm thiết bị cho phiếu nhập <%=getmapn() %></div>
</div>
