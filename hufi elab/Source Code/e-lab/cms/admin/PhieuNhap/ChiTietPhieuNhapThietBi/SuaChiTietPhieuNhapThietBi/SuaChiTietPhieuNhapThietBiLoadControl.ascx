<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuaChiTietPhieuNhapThietBiLoadControl.ascx.cs" Inherits="e_lab.cms.admin.PhieuNhap.ChiTietPhieuNhapThietBi.SuaChiTietPhieuNhapThietBi.SuaChiTietPhieuNhapThietBiLoadControl" %>

<div class="to-do-heading">
    <div class="to-do-heading-icon-list">
        <a href="/Admin.aspx?modul=ChiTietPhieuNhapThietBi&mapn=<%=getmapn() %>&trang=1" class="Back" <%--style="color:#fff; text-decoration: none"--%>>
            <i class="to-do-heading-icon fa-solid fa-circle-chevron-left" title=" Quay lại"></i>
        </a>
    </div>
    <div class="heading-text">Cập nhật số lượng cho thiết bị <%=getmatb() %> trong phiếu nhập <%=getmapn() %></div>
</div>
