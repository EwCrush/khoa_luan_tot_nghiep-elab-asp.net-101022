<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemDungCuLoadControl.ascx.cs" Inherits="e_lab.cms.admin.DungCu.ThemDungCu.ThemDungCuLoadLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Thêm dụng cụ</div>
</div>
