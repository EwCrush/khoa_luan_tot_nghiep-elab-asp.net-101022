...
namespace e_lab.cms.admin.NhaCungCap
{
    public partial class NhaCungCapLoadControl : System.Web.UI.UserControl
    {
        string trang = "";
        int trangcuoi = 0;
        int trangtruoc = 0;
        ...
        {
            DataTable dt = new DataTable();
            dt = e_lab.NhaCungCap.ds_NhaCungCap_pagination(getoffset());
