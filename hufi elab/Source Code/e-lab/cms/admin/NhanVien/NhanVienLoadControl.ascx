<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhanVienLoadControl.ascx.cs" Inherits="e_lab.cms.admin.NhanVien.NhanVienLoadControl" %>

<div class="to-do-heading">

    <div class="heading-text no-icon-link">Danh sách nhân viên</div>
    <div class="search">
            <div class="tk">
                <asp:TextBox ID="iptk" CssClass ="cssiptk" runat="server"></asp:TextBox>
                <a href="/Admin.aspx?modul=TimKiemNhanVien&keyword=<%=get_iptk() %>&trang=1" class="ThemMoi">
...
<div class="pagination-wrapper">
    <div class="pagination floatleft-item">
        <a href="/Admin.aspx?modul=ThemNV" class="ThemMoi">
            <i class="to-do-heading-icon fa-solid fa-circle-plus" title="Thêm"></i>
        </a>
    </div>
    <div class="pagination">
        <a href="/Admin.aspx?modul=NhanVien&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/Admin.aspx?modul=NhanVien&trang=<%=getnext() %>" class="ThemMoi">
