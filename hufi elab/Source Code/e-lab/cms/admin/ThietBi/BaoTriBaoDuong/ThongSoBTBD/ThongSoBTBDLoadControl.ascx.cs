...
namespace e_lab.cms.admin.ThietBi.BaoTriBaoDuong.ThongSoBTBD
{
    public partial class ThongSoBTBDLoadControl : System.Web.UI.UserControl
    {
        string trang = "";
        int trangcuoi = 0;
        int trangtruoc = 0;
        ...
        private void layDSTB()
        {
            ...
            <td class='tb_mi30 table_info'>" + dt.Rows[i]["MaTS"] + @"</td>
