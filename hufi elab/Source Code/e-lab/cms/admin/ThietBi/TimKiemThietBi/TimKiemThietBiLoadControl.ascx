<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TimKiemThietBiLoadControl.ascx.cs" Inherits="e_lab.cms.admin.ThietBi.TimKiemThietBi.TimKiemThietBiLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Danh sách thiết bị có tên là <%=getkeyword() %></div>
</div>
...
<div class="pagination-wrapper">
    ...
    <div class="pagination">
        <a href="/Admin.aspx?modul=TimKiemThietBi&keyword=<%=getkeyword() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/Admin.aspx?modul=TimKiemThietBi&keyword=<%=getkeyword() %>&trang=<%=getnext() %>" class="ThemMoi">
