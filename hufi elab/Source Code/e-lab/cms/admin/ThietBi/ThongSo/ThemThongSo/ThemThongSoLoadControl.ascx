<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemThongSoLoadControl.ascx.cs" Inherits="e_lab.cms.admin.ThietBi.ThongSo.ThemThongSo.ThemThongSoLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Thêm thông số cho thiết bị <%=getmatb() %></div>
</div>
