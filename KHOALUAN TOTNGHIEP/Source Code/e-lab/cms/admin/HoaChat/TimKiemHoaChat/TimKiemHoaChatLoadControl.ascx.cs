...
namespace e_lab.cms.admin.HoaChat.TimKiemHoaChat
{
    public partial class TimKiemHoaChat : System.Web.UI.UserControl
    {
        string trang = "";
        int trangcuoi = 0;
        int trangtruoc = 0;
        ...
        protected int getlast()
        {
            ...
            dt = e_lab.HoaChat.ds_hc_search(keyword);
        ...
        private void layDSHC_search()
        {
            DataTable dt = new DataTable();
            dt = e_lab.HoaChat.ds_HoaChat_search_pagination(keyword, getoffset());
            ...
            <td class='tb_col_10_percent table_info'>" + dt.Rows[i]["NgayNhap"] + @"</td>
            ...
            <td class='tb_col_15_percent table_info'>
                <a href='/Admin.aspx?modul=ThongTinThemHoaChat&mahc=" + dt.Rows[i]["MaHC"] + @"' class='tb_thaotac_link'>
                ...
                <a href='javascript:XoaHC(" + dt.Rows[i]["MaHC"] + @", " + dt.Rows[i]["SoLuongXuat"] + @")' class='tb_thaotac_link'>
