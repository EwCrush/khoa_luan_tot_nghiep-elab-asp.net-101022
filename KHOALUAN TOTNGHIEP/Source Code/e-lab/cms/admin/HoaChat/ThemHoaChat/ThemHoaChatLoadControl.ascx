<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemHoaChatLoadControl.ascx.cs" Inherits="e_lab.cms.admin.HoaChat.ThemHoaChat.ThemHoaChatLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Thêm hóa chất</div>
</div>
...
<div class="ThaoTac-PhongLab">
    ...
    <asp:Button ID="btthem" Class="btnThem" runat="server" Text="Thêm" OnClick="btn_themnsx_Click"  />
    <asp:Button ID="btnsua" Class="btnThem" runat="server" Text="Nhập lại" OnClick="btn_nhaplai_themnsx_Click" />
</div>