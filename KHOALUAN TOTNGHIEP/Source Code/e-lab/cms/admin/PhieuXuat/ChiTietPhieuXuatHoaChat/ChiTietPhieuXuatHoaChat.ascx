<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietPhieuXuatHoaChat.ascx.cs" Inherits="e_lab.cms.admin.PhieuXuat.ChiTietPhieuXuatHoaChat.ChiTietPhieuXuatHoaChat" %>
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/Admin.aspx?modul=ChiTietPhieuXuatHoaChat&mapx=<%=getmapx() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/Admin.aspx?modul=ChiTietPhieuXuatHoaChat&mapx=<%=getmapx() %>&trang=<%=getnext() %>" class="ThemMoi">
