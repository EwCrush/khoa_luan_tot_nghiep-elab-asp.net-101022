<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietPhieuXuatDungCu.ascx.cs" Inherits="e_lab.cms.admin.PhieuXuat.ChiTietPhieuXuatDungCu.ChiTietPhieuXuatDungCu" %>
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/Admin.aspx?modul=ChiTietPhieuXuatDungCu&mapx=<%=getmapx() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/Admin.aspx?modul=ChiTietPhieuXuatDungCu&mapx=<%=getmapx() %>&trang=<%=getnext() %>" class="ThemMoi">
