<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TimKiemNhanVienLoadControl.ascx.cs" Inherits="e_lab.cms.admin.NhanVien.TimKiemNhanVien.TimKiemNhanVienLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Danh sách nhân viên có tên <%=get_keyword() %></div>
</div>
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/Admin.aspx?modul=TimKiemNhanVien&keyword=<%=get_keyword() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/Admin.aspx?modul=TimKiemNhanVien&keyword=<%=get_keyword() %>&trang=<%=getnext() %>" class="ThemMoi">
