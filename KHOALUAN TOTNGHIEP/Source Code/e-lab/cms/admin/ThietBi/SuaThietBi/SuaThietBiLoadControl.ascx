<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuaThietBiLoadControl.ascx.cs" Inherits="e_lab.cms.admin.ThietBi.SuaThietBi.SuaThietBiLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Chỉnh sửa thông tin thiết bị <%=getmatb() %></div>
</div>
