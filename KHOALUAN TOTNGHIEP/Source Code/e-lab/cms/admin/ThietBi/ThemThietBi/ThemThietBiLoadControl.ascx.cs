...
{
    public partial class ThemThietBiLoadControl : System.Web.UI.UserControl
    {
        ...
        protected void btn_them_Click(object sender, EventArgs e)
        {
            ...
            e_lab.ThietBi.them_TB(TenTB.Text, ddl_nsx.SelectedValue, ddl_ncc.SelectedValue, soluongton, NgayBaoDuong.Text, DVT.Text);
