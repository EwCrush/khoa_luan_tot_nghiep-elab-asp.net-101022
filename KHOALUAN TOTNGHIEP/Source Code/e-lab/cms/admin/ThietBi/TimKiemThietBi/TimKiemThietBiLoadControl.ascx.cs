...
namespace e_lab.cms.admin.ThietBi.TimKiemThietBi
{
    public partial class TimKiemThietBiLoadControl : System.Web.UI.UserControl
    {
        ...
        protected int getlast()
        {
            ...
            dt = e_lab.ThietBi.ds_tb_search(keyword);
        ...
        {
            DataTable dt = new DataTable();
            dt = e_lab.ThietBi.ds_ThietBi_search_pagination(keyword, getoffset());
            ...
            <td class='tb_col_15_percent table_info'>
                ...
                <a href='/Admin.aspx?modul=LichSuSuDung&matb=" + dt.Rows[i]["MaTB"] + @"' class='tb_thaotac_link'>
