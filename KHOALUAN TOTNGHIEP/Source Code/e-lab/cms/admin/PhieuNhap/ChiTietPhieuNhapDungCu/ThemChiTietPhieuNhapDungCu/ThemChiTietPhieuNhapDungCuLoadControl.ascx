<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemChiTietPhieuNhapDungCuLoadControl.ascx.cs" Inherits="e_lab.cms.admin.PhieuNhap.ChiTietPhieuNhapDungCu.ThemChiTietPhieuNhapDungCu.ThemChiTietPhieuNhapDungCuLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Thêm dụng cụ cho phiếu nhập <%=getmapn() %></div>
</div>
