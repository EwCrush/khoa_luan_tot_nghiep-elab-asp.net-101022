<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CTPNDungCuLoadControl.ascx.cs" Inherits="e_lab.cms.admin.PhieuNhap.ChiTietPhieuNhapDungCu.CTPNDungCu.CTPNDungCuLoadControl" %>
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/Admin.aspx?modul=CTPNDungCu&mapn=<%=getmapn() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/Admin.aspx?modul=CTPNDungCu&mapn=<%=getmapn() %>&trang=<%=getnext() %>" class="ThemMoi">
