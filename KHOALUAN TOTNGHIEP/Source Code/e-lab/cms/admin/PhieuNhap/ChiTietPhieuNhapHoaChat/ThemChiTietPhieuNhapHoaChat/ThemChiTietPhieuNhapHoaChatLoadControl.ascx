<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemChiTietPhieuNhapHoaChatLoadControl.ascx.cs" Inherits="e_lab.cms.admin.PhieuNhap.ChiTietPhieuNhapHoaChat.ThemChiTietPhieuNhapHoaChat.ThemChiTietPhieuNhapLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Thêm hóa chất cho phiếu nhập <%=getmapn() %></div>
</div>
