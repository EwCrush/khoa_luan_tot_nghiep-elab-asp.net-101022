<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TimKiemTaiKhoanLoadControl.ascx.cs" Inherits="e_lab.cms.admin.TaiKhoan.TimKiemTaiKhoan.TimKiemTaiKhoanLoadControl" %>
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/Admin.aspx?modul=TimKiemTaiKhoan&keyword=<%=get_keyword() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/Admin.aspx?modul=TimKiemTaiKhoan&keyword=<%=get_keyword() %>&trang=<%=getnext() %>" class="ThemMoi">
