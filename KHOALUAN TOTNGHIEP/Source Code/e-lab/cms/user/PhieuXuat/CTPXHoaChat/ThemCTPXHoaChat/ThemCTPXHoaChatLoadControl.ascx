<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemCTPXHoaChatLoadControl.ascx.cs" Inherits="e_lab.cms.user.PhieuXuat.CTPXHoaChat.ThemCTPXHoaChat.ThemCTPXHoaChatLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Thêm hóa chất cho phiếu xuất <%=getmapxk() %></div>
</div>
