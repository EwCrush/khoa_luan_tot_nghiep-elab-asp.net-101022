<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuaPhieuXuatLoadControl.ascx.cs" Inherits="e_lab.cms.user.PhieuXuat.SuaPhieuXuat.SuaPhieuXuatLoadControl" %>
...
<div class="to-do-heading">
    ...
    <div class="heading-text">Cập nhật thông tin cho phiếu xuất <%=getmapxk() %></div>
</div>
