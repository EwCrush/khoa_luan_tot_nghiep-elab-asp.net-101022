...
namespace e_lab.cms.user.PhieuNhap.PhieuNhapDangChoDuyet
{
    public partial class PhieuNhapDangChoDuyet : System.Web.UI.UserControl
    {
        string trang = "";
        int trangcuoi = 0;
        int trangtruoc = 0;
        ...
        {
            DataTable dt = new DataTable();
            dt = e_lab.PhieuXuat.ds_PhieuXuat_dangchoduyet_pagination_khoa(Session["MaDonVi"].ToString(), getoffset());
            ...
            <td class='tb_mi15 table_info'>
                <a href='javascript:ThuHoiPX(" + dt.Rows[i]["MaPX"] + @")' class='tb_thaotac_link'>
                 <i class='tb_thaotac_link_icon fa-solid fa-arrow-rotate-left' title='Thu hồi'></i>
                </a>
