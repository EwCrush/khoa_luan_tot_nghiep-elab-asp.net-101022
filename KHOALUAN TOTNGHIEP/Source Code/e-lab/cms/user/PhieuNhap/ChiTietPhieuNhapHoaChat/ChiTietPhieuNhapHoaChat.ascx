<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietPhieuNhapHoaChat.ascx.cs" Inherits="e_lab.cms.user.PhieuNhap.ChiTietPhieuNhapHoaChat.ChiTietPhieuNhapHoaChat" %>
...
<div class="pagination-wrapper">
    <div class="pagination">
        <a href="/User.aspx?modul=ChiTietPhieuNhapHoaChat&mapx=<%=getmapx() %>&trang=<%=getpre() %>" class="ThemMoi">
        ...
        <a href="/User.aspx?modul=ChiTietPhieuNhapHoaChat&mapx=<%=getmapx() %>&trang=<%=getnext() %>" class="ThemMoi">
